...
- 소감 : 코딩도 코딩이지만 학습은 언제나 필요하다.


### Day 14
>생활코딩 지옥에서 온 깃 1~16 학습하기 (완료)
 
>자바의 정석 연산자 재 학습하기 (완료)


- 소감 : 터미널 활용하는 법을 더 익히고싶다..  


### Day 15
>가계부 구현 - 삭제 및 수정 메서드 블로그 작성 (진행중)
 
>알고리즘 풀이 
 
- 소감 : 어느덧 3주차가 끝나고.. 이전의 내 모습보단 달라진걸 느낄 수 있었다.. 멋진 몸을 만들기 보단, 그 멋진 몸을 만들기 위한 루틴(시스템) 을 구성 하듯이, 코딩도 이 방식대로 해야지! 